...
export default class App extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (prevState.account !== this.state.account) {
      this.getUserData(this.state.account, this.getCurrentDate());
    }
    if (prevState.allItems !== this.state.allItems) {
      this.setState({ allItems: this.state.allItems });
    }
    if (prevState.todayItems !== this.state.todayItems) {
      this.setState({ todayItems: this.state.todayItems });
    }
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div>
          {route === "login" && (
            <LogIn eventEmitter={eventEmitter} loginCallback={this.login} />
          )}
        </div>
          ...
          >
            ...
            {route === "chart" && (
              <DailyExpense
                ...
                month={month}
                monthItems={this.state.monthItems}
            ...
            {route === "record" && (
              <InputContent
                eventEmitter={eventEmitter}
                items={allItems}
                monthOfBudget={monthOfBudget}
                account={account}
                setBudgetCallback={this.setBudget}
            ...
            {route === "total" && (
              <TotalExpense
                items={allItems}
                detailOfMonth={this.showDetailOfMonth}
              />
            )}
            {route === "detailOfMonth" && (
              <DetailMonth
                ...
                updateShowDetailOfMonth={this.showDetailOfMonth}
              />
            )}
