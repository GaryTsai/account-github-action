...
class InputContent extends Component {
  ...
  monthOfCost = () => {
    ...
    const whichMonth =
      ...
      "-" +
      utils.toDualDigit(newStartDate.getMonth() + 1);
  ...
  render() {
    ...
    const remainDays =
      utils.days(new Date().getFullYear(), new Date().getMonth() + 1) + 1 - day;
    const percentage = (
      ((parseInt(monthOfBudget) - this.monthOfCost()) /
        parseInt(monthOfBudget)) *
      100
    ).toFixed(0);
      ...
      <div>
        <div style={styles.mainExpense}>
          ...
          <div style={styles.expenseOfStyle}>
            該日花費:{" "}
            <span style={styles.expense}>
              {this.todayOfCost(items)} <span style={styles.unit}>$NT</span>
            </span>
          </div>
          <div style={styles.expenseOfStyle}>
            實際支出:{" "}
        ...
        <div style={styles.inputBudget}>
          <div className="col">
            <input
              ...
              placeholder="日期"
              onChange={(c) => this.handleChange(c.target.value)}
        ...
        {this.isSmallDevices() && (
          <div style={{ ...styles.inputBudget, borderTop: "1px solid black" }}>
            <div
              style={{
                width: "50%",
              }}
        ...
        {isSmallDevice && (
          <button
            type="submit"
            key={"item-submit"}
            style={{ ...styles.submit, borderTop: "1px solid black" }}
            onClick={() => this.submitContent()}
          >
            儲存
          </button>
